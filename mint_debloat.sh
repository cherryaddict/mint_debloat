...
sudo apt purge simple-scan* firefox* libreoffice* hexchat* hypnotix* xviewer* xreader* thingy* onboard* drawing* pix* rhythmbox* thunderbird* warpinator* mintwelcome* blueman* mintbackup* gnome-disk-utility* baobab* bulky* sticky* system-config-printer* timeshift* *flatpak* gnome-system-monitor* xed* mintupdate synaptic
